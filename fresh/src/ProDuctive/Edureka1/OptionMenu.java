...
public class OptionMenu extends Account{
    ...
    /*Validate login information customer number and pin no. */
    ...
    public  void getSaving(){
        ...
        switch (selection){
            case 1:
                System.out.println("Saving Account Balnce: " + moneyFormat.format(getSavingBalance()));
                getAccountType();
                System.out.flush();
                break;
